...
#define DEFAULT_AXIS_STEPS_PER_UNIT {80,80,4000,843,625,625,625,625,625}
#define DEFAULT_MAX_FEEDRATE {2000,2000,3,25,100,100,100,100,100}
#define MANUAL_FEEDRATE {100*60,100*60,2*60,10*60}
#define DEFAULT_MINIMUMFEEDRATE       0.0
#define DEFAULT_MINTRAVELFEEDRATE     0.0
#define MINIMUM_PLANNER_SPEED         0.05                      // (mm/sec)
#define DEFAULT_MAX_ACCELERATION {2000,2000,50,1000,3000,3000,3000,3000,3000}
#define DEFAULT_RETRACT_ACCELERATION {2000,10000,10000,10000,10000,10000}
